...
namespace SvoyaIgra.Utils.Controllers
{
    public class GameController
    {
        ...
        private readonly ClientServer.Server server;
        private readonly ClientServer.Client client;
        ...
        public GameController(bool isServer, string ip, string name, string imgUrl, string packPath = null)
        {
            ...
            if (isServer)
            {
                ...
                server = new ClientServer.Server(ip, GetMessageToSend, OnServerError);
                server.SetLogPath(System.Windows.Forms.Application.StartupPath);
                server.AddActionGetMessage(OnGetMessage);
                server.GetFileName += GetFileName;
                server.SetWorkPath(loader.WorkDirectory);
                server.OnFileLoaded += FileLoad;
            ...
            else
            {
                ...
                client = new ClientServer.Client(ip, name, OnClientError);
                client.SetWorkPath(loader.WorkDirectory);
                client.SetLogPath(System.Windows.Forms.Application.StartupPath);
                client.GetMessageForServer += GetMessageToSend;
                client.OnFileLoaded += FileLoad;
        ...
        private void OnServerError(Exception ex, string token)
        {
            lock (users)
            {
                ...
                var message = new ClientServer.Message()
                    ...
                    .SetType(ClientServer.Message.MessageType.Kick)
                    .Add("token", token);
        ...
        private void FileLoad(ClientServer.Message.FileType type, string filePath)
        {
            switch (type)
            {
                case ClientServer.Message.FileType.Pack:
                    {
                        if (!isServer)
                        {
                            ...
                            var message = new ClientServer.Message()
                                ...
                                .SetType(ClientServer.Message.MessageType.Ready);
                ...
                case ClientServer.Message.FileType.AdminImg:
                    {
                        if (!isServer)
                        {
                ...
                case ClientServer.Message.FileType.UserImg:
                    {
                        ...
                        if (isServer)
                        {
                            var message = new ClientServer.Message()
                                .SetToken(ClientServer.Server.ServerToken)
                                .SetType(ClientServer.Message.MessageType.AvailableImage)
        ...
        private void OnGetMessage(ClientServer.Message message)
        {
            if (state == State.End)
            {
                return;
            ...
            lock (users)
            {
                ...
                switch (message.Type)
                {
                    case ClientServer.Message.MessageType.GetReg:
                        {
                            if (isServer)
                            {
                                ...
                                var sendMessage = new ClientServer.Message()
                                    .SetType(ClientServer.Message.MessageType.AddToChat)
                                    .SetToken(ClientServer.Server.ServerToken)
                                ...
                                var sendUserData = new ClientServer.Message()
                                    .SetType(ClientServer.Message.MessageType.SendUserData)
                                    .SetToken(ClientServer.Server.ServerToken)
                                ...
                                {
                                    sendUserData = new ClientServer.Message()
                                        .SetType(ClientServer.Message.MessageType.SendUserData)
                                        .SetToken(ClientServer.Server.ServerToken)
                                    ...
                                    {
                                        var imgAvailableMessage = new ClientServer.Message()
                                            .SetType(ClientServer.Message.MessageType.AvailableImage)
                                            .SetToken(ClientServer.Server.ServerToken)
                                ...
                                var adminData = new ClientServer.Message()
                                    .SetToken(ClientServer.Server.ServerToken)
                                    .SetType(ClientServer.Message.MessageType.SendAdminData)
                                    .Add("name", adminName);
                                ...
                                if (isGameStarted)
                                {
                                    ...
                                    var message1 = new ClientServer.Message()
                                        .SetToken(ClientServer.Server.ServerToken)
                                        .SetType(ClientServer.Message.MessageType.ForseShowMain)
                    ...
                    case ClientServer.Message.MessageType.AddToChat:
                        {
                            if (isServer)
                            {
                                AddMessageForAll(message);
                    ...
                    case ClientServer.Message.MessageType.SendUserData:
                        {
                            ...
                            if (userToken.Equals(client.Token))
                            {
                                ...
                                var imageMessage = new ClientServer.Message()
                                    .SetToken(client.Token)
                                    .SetType(ClientServer.Message.MessageType.SendFile)
                                    .Add("fileName", client.Token)
                                    .Add("fileType", ClientServer.Message.FileType.UserImg.ToString());
                    ...
                    case ClientServer.Message.MessageType.StartGame:
                        {
                    ...
                    case ClientServer.Message.MessageType.Ready:
                        {
                    ...
                    case ClientServer.Message.MessageType.ChoiseQuestion:
                        {
                            if (isServer)
                            {
                                ...
                                var sendMessage = new ClientServer.Message()
                                    .SetToken(ClientServer.Server.ServerToken)
                                    .SetType(ClientServer.Message.MessageType.ShowQuestion)
                    ...
                    case ClientServer.Message.MessageType.ShowQuestion:
                        {
                            int round = int.Parse(message.GetData("round"));
                            int theme = int.Parse(message.GetData("theme"));
                            int question = int.Parse(message.GetData("question"));
                    ...
                    case ClientServer.Message.MessageType.ChoiseTheme:
                        {
                            if (!isServer)
                            {
                                canChoise = message.GetData("token").Equals(client.Token);
                    ...
                    case ClientServer.Message.MessageType.SetPause:
                        {
                            gameForm.Pause();
                            isGamePaused = true;
                        }
                    ...
                    case ClientServer.Message.MessageType.TryAnswer:
                        {
                            ...
                            if (isServer)
                            {
                                ...
                                if (isCanAnswer || true)
                                {
                                    var messageSend = new ClientServer.Message()
                                        .SetToken(ClientServer.Server.ServerToken)
                                        .SetType(ClientServer.Message.MessageType.SetPause);
                    ...
                    case ClientServer.Message.MessageType.ShowAnswer:
                        {
                            nowAnswerScenario = 0;
                    ...
                    case ClientServer.Message.MessageType.AdminSay:
                        {
                            gameForm.SetAdminSay(message.GetData("text"));
                        }
                        break;

                    case ClientServer.Message.MessageType.UpdateMoney:
                        {
                            var userToken = message.GetData("token");
                    ...
                    case ClientServer.Message.MessageType.SendAdminData:
                        {
                            gameForm.SetAdminData(message.GetData("name"));
                        }
                        break;

                    case ClientServer.Message.MessageType.Kick:
                        {
                    ...
                    case ClientServer.Message.MessageType.ForseShowMain:
                        {
                            if (!isServer)
                            {
                    ...
                    case ClientServer.Message.MessageType.SendUsedQuestion:
                        {
                    ...
                    case ClientServer.Message.MessageType.SendFile:
                    case ClientServer.Message.MessageType.GetFile:
                        {
                            if (isServer)
                            {
                    ...
                    case ClientServer.Message.MessageType.FileSended:
                        {
                            if (isServer)
                            {
                    ...
                    case ClientServer.Message.MessageType.StartCanAnswer:
                        {
                            if (!isServer)
                            {
                    ...
                    case ClientServer.Message.MessageType.AvailableImage:
                        {
                    ...
                    case ClientServer.Message.MessageType.UserClickUser:
                        {
                            ...
                            if (isServer)
                            {
                                ...
                                user.AddDataToSend(new ClientServer.Message().SetToken(ClientServer.Server.ServerToken).SetType(ClientServer.Message.MessageType.StartAutoAnswer));
                                AddMessageForAll(new ClientServer.Message().SetToken(ClientServer.Server.ServerToken).SetType(ClientServer.Message.MessageType.ForceShowQuestion));
                    ...
                    case ClientServer.Message.MessageType.CanChoiceUser:
                        {
                            if (!isServer)
                            {
                    ...
                    case ClientServer.Message.MessageType.StartAutoAnswer:
                        {
                            if (!isServer)
                            {
                                autoAnswer = true;
                    ...
                    case ClientServer.Message.MessageType.ForceShowQuestion:
                        {
                            if (!isServer)
                            {
                                gameForm.SetCanChoise(false);
                    ...
                    case ClientServer.Message.MessageType.AuctionChoice:
                        {
                            if (isServer)
                            {
                    ...
                    case ClientServer.Message.MessageType.AddTextToMainScreen:
                        {
                            if (!isServer)
                            {
                    ...
                    case ClientServer.Message.MessageType.EndGame:
                        {
                            if (!isServer)
                            {
                                state = State.End;
                    ...
                    case ClientServer.Message.MessageType.KickTheme:
                        {
                            if (!(messageToken.Equals(ClientServer.Server.ServerToken) || messageToken.Equals(userTokenQueue.Peek())))
                            {
                                break;
                            }
                            ...
                            if (isServer)
                            {
                                ...
                                if (countThemes == 1)
                                {
                                    ...
                                    var messageSend = new ClientServer.Message()
                                        .SetToken(ClientServer.Server.ServerToken)
                                        .SetType(ClientServer.Message.MessageType.AddTextToMainScreen)
                                        .Add("text", nowShowText)
                                        .Add("show", true.ToString());
                                    AddMessageForAll(messageSend);

                                    messageSend = new ClientServer.Message()
                                        .SetToken(ClientServer.Server.ServerToken)
                                        .SetType(ClientServer.Message.MessageType.FinalRate);
                                ...
                                else
                                {
                                    var sendMessage = new ClientServer.Message()
                                       .SetToken(ClientServer.Server.ServerToken)
                                       .SetType(ClientServer.Message.MessageType.KickTheme)
                    ...
                    case ClientServer.Message.MessageType.FinalRate:
                        {
                            isFinal = true;
        ...
        private string GetMessageToSend(string token, out ClientServer.Message.MessageType type)
        {
            lock (users)
            {
                foreach (var user in users)
                {
                    ...
                    {
                        return user.GetMessage(out type);
                    }
                }
            }

            type = ClientServer.Message.MessageType.Kick;
            return new ClientServer.Message()
                .SetToken(ClientServer.Server.ServerToken)
                .SetType(type)
                .Add("token", token)
                .GetJson();
                        ...
                        else
                        {
                            if (isServer)
                            {
                                lock (users)
                                {
                                    ...
                                    var trueMessage = new ClientServer.Message()
                                        .SetToken(ClientServer.Server.ServerToken)
                                        .SetType(isFinal ? ClientServer.Message.MessageType.ChoiseTheme : ClientServer.Message.MessageType.ChoiseQuestion)
        ...
        private void PlayScenarioAnswer()
        {
            if (isServer && nowAnswerScenario == 0)
            {
                var message = new ClientServer.Message()
                    .SetToken(ClientServer.Server.ServerToken)
                    .SetType(ClientServer.Message.MessageType.ShowAnswer);
                AddMessageForAll(message);
            }
        ...
        private void OnRectClick(int x, int y)
        {
            ...
            if (!isServer)
            {
                ...
                if (state == State.ChoiseQuestion)
                {
                    ...
                    var message = new ClientServer.Message()
                        .SetToken(client.Token)
                        .SetType(ClientServer.Message.MessageType.ChoiseQuestion)
                        .Add("round", nowRound.ToString())
            ...
            if (nowQuestion.IsBagcat)
            {
                ...
                if (isServer)
                {
                    ...
                    if (user != null)
                    {
                        var message = new ClientServer.Message()
                            .SetToken(ClientServer.Server.ServerToken)
                            .SetType(ClientServer.Message.MessageType.CanChoiceUser);
        ...
        private bool StartStop(bool forse)
        {
            lock (users)
            {
                if (!isGameStarted)
                {
                    ...
                    var message = new ClientServer.Message()
                        .SetToken(ClientServer.Server.ServerToken)
                        .SetType(ClientServer.Message.MessageType.StartGame)
                        .Add("round", nowRound.ToString());
                ...
                else
                {
                    ...
                    if (!isGamePaused)
                    {
                        message.SetType(ClientServer.Message.MessageType.SetPause);
                        gameForm.Pause();
                        isGamePaused = true;
                    }
                    else
                    {
                        message.SetType(ClientServer.Message.MessageType.StartGame)
                            .Add("round", nowRound.ToString());
                        gameForm.Start();
                        isGamePaused = false;
                    }
        ...
        private void AddMessageForAll(ClientServer.Message message)
        {
            lock (users)
            {
                foreach (var user in users)
            ...
            lock (users)
            {
                ...
                else
                {
                    if (!token.Equals(client.Token))
                    {
                        ...
                        var message = new ClientServer.Message()
                            .SetToken(client.Token)
                            .SetType(ClientServer.Message.MessageType.UserClickUser)
                            .Add("token", token);
                        AddMessageForAll(message);
                    }
                }
        ...
        private void AdminSay(string data)
        {
            lock (users)
            {
                if (isServer)
                {
                    ...
                    var message = new ClientServer.Message()
                            .SetToken(ClientServer.Server.ServerToken)
                            .SetType(ClientServer.Message.MessageType.AdminSay)
                            .Add("text", data);
        ...
        private void OnTryAnswerClick()
        {
            if (!isServer)
            {
                lock (users)
                {
                    var message = new ClientServer.Message()
                        .SetToken(client.Token)
                        .SetType(ClientServer.Message.MessageType.TryAnswer);
        ...
        private void UpdateUser(Data.User user)
        {
            lock (users)
            {
                ...
                var updateMessage = new ClientServer.Message()
                       .SetToken(ClientServer.Server.ServerToken)
                       .SetType(ClientServer.Message.MessageType.UpdateMoney)
        ...
        private void Kick(Data.User user)
        {
            lock (users)
            {
                var adminSayMessage = new ClientServer.Message()
                          .SetToken(ClientServer.Server.ServerToken)
                          .SetType(ClientServer.Message.MessageType.AddToChat)
        ...
        private void SendRoundData(Data.User user)
        {
            var message = new ClientServer.Message()
                .SetToken(ClientServer.Server.ServerToken)
                .SetType(ClientServer.Message.MessageType.SendUsedQuestion)
                .Add("round", nowRound.ToString());
        ...
        private string GetFileName(ClientServer.Message.FileType type)
        {
            switch (type)
            {
                case ClientServer.Message.FileType.AdminImg:
                    return Data.User.AdminImgName;
                case ClientServer.Message.FileType.Pack:
                    return DataStore.Utils.PackUtils.PackManager.BasePackName;
                default:
                    return "";
            }
        }
        ...
        private void OnAuctionMove(int rate)
        {
            ...
            lock (users)
            {
                ...
                var message = new ClientServer.Message()
                     .SetToken(client.Token)
                     .SetType(state == State.FinalRate ? ClientServer.Message.MessageType.FinalRate : ClientServer.Message.MessageType.AuctionChoice)
        ...
        private void FinalAnswer(string data)
        {
            lock (users)
            {
                var message = new ClientServer.Message()
                    .SetToken(client.Token)
                    .SetType(ClientServer.Message.MessageType.FinalAnswer)
                    .Add("data", data);
        ...
        private void EndGame(string data)
        {
            ...
            var messageEnd = new ClientServer.Message()
                .SetToken(ClientServer.Server.ServerToken)
                .SetType(ClientServer.Message.MessageType.AddTextToMainScreen)
                .Add("text", data)
            ...
            var message = new ClientServer.Message()
                .SetToken(ClientServer.Server.ServerToken)
                .SetType(ClientServer.Message.MessageType.EndGame);
            AddMessageForAll(message);
        }
        ...
        private void NextUserMove()
        {
            lock (users)
            {
                if (state == State.ChoiseFinalTheme)
                {
                    ...
                    var sendMessage = new ClientServer.Message()
                      .SetToken(ClientServer.Server.ServerToken)
                      .SetType(ClientServer.Message.MessageType.ChoiseTheme)
